...
'.(($cx['funcs']['ifvar']($cx, ((isset($in['in_search']) && is_array($in)) ? $in['in_search'] : null))) ? '
            <div class="codo_topics_topic_title"><a href="'.$cx['funcs']['ch']($cx, 'const', array(array('RURI'),array()), 'raw').'topic/'.((isset($in['topic_id']) && is_array($in)) ? $in['topic_id'] : null).'/'.((isset($in['safe_title']) && is_array($in)) ? $in['safe_title'] : null).'/post-'.((isset($in['post_id']) && is_array($in)) ? $in['post_id'] : null).'#post-'.((isset($in['post_id']) && is_array($in)) ? $in['post_id'] : null).'">'.((isset($in['title']) && is_array($in)) ? $in['title'] : null).'</a></div>
' : '
'.(($cx['funcs']['ifvar']($cx, ((isset($in['new_replies']) && is_array($in)) ? $in['new_replies'] : null))) ? '            <div class="codo_topics_topic_title"><a href="'.$cx['funcs']['ch']($cx, 'const', array(array('RURI'),array()), 'raw').'topic/'.((isset($in['topic_id']) && is_array($in)) ? $in['topic_id'] : null).'/'.((isset($in['safe_title']) && is_array($in)) ? $in['safe_title'] : null).'/post-'.((isset($in['first_new_reply']) && is_array($in)) ? $in['first_new_reply'] : null).'#post-'.((isset($in['first_new_reply']) && is_array($in)) ? $in['first_new_reply'] : null).'" style="font-size:16px;">'.((isset($in['title']) && is_array($in)) ? $in['title'] : null).'</a></div>
' : '            <div class="codo_topics_topic_title"><a href="'.$cx['funcs']['ch']($cx, 'const', array(array('RURI'),array()), 'encq').'topic/'.((isset($in['topic_id']) && is_array($in)) ? $in['topic_id'] : null).'/'.((isset($in['safe_title']) && is_array($in)) ? $in['safe_title'] : null).'" style="font-size:16px;">'.((isset($in['title']) && is_array($in)) ? $in['title'] : null).'</a></div>
').'').'
            <div class="codo_topics_topic_name">
                <a href="'.$cx['funcs']['ch']($cx, 'const', array(array('RURI'),array()), 'encq').'user/profile/'.((isset($in['id']) && is_array($in)) ? $in['id'] : null).'"><span class="role_'.((isset($in['role']) && is_array($in)) ? $in['role'] : null).'">'.((isset($in['name']) && is_array($in)) ? $in['name'] : null).'</span></a>
...
'.(($cx['funcs']['ifvar']($cx, ((isset($in['overflow']) && is_array($in)) ? $in['overflow'] : null))) ? '
                <a href="'.$cx['funcs']['ch']($cx, 'const', array(array('RURI'),array()), 'raw').'topic/'.htmlentities((string)((isset($in['topic_id']) && is_array($in)) ? $in['topic_id'] : null), ENT_QUOTES, 'UTF-8').'/'.((isset($in['safe_title']) && is_array($in)) ? $in['safe_title'] : null).'" class="codo_readmore">'.$cx['funcs']['ch']($cx, 'i18n', array(array('read more'),array()), 'encq').'</a>
' : '').'            </div>
            <div class="col-md-10 col-xs-12 codo_readmore_container">
                <!--'.(($cx['funcs']['ifvar']($cx, ((isset($in['tags']) && is_array($in)) ? $in['tags'] : null))) ? '
...
'.(($cx['funcs']['ifvar']($cx, ((isset($in['last_post_time']) && is_array($in)) ? $in['last_post_time'] : null))) ? '            <div class="codo_topics_last_post">
                ...
                &nbsp;&middot;&nbsp; <span class=\'codo_topics_last_post_time\'><a href="'.$cx['funcs']['ch']($cx, 'const', array(array('RURI'),array()), 'raw').'topic/'.((isset($in['topic_id']) && is_array($in)) ? $in['topic_id'] : null).'/'.((isset($in['safe_title']) && is_array($in)) ? $in['safe_title'] : null).'/post-'.((isset($in['last_post_id']) && is_array($in)) ? $in['last_post_id'] : null).'#post-'.((isset($in['last_post_id']) && is_array($in)) ? $in['last_post_id'] : null).'">'.htmlentities((string)((isset($in['last_post_time']) && is_array($in)) ? $in['last_post_time'] : null), ENT_QUOTES, 'UTF-8').'</a></span>
            </div>
