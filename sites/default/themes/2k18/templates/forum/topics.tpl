        ...
        <div class="row">
            ...
            <div>
                ...
                <div class="codo_icon_header col-lg-12 visible-sm visible-xs">
                    ...
                    <i onclick="codo_create_topic()" class="icon-new-topic" title="{_t("Create new topic")}"></i>
                    <i onclick="CODOF.toggleTopicsAndCategories()" class="icon-books" title="{_t("Categories")}"></i>
    ...
    {if !$load_more_hidden}
        <div class="codo_topics_loadmore_div row" id="codo_topics_load_more">
            ...
            <div onclick="CODOF.changePage(this, {$curr_page}, 'prev')"
                 class="pagination_previous_page col-md-offset-1 col-md-2 col-sm-12{if $curr_page neq 1} active_page_controls{/if}">
